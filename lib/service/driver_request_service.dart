...
class DriverRequestService {
  ...
  static Future<Map<String, dynamic>> getRequestDetails(
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/driver-requests/$requestId/review'),
        headers: {
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
        },
  ...
  static Future<Map<String, dynamic>> acceptRequest(String requestId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/api/driver-requests/$requestId/accept'),
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
  ...
  static Future<Map<String, dynamic>> declineRequest(String requestId) async {
    try {
      ...
      final response = await http.post(
        Uri.parse('$baseUrl/api/driver-requests/$requestId/decline'),
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
  ...
  static Future<Map<String, dynamic>> getNavigationPayload(
    ...
    try {
      ...
      final response = await http.get(
        Uri.parse('$baseUrl/api/driver-requests/$requestId/navigation'),
        headers: {
          'Accept': 'application/json',
          'Authorization': 'Bearer $token',
        },
